...
navBtn.addEventListener('click', () => {
    if (nav.getAttribute("data-isMyMenuVisible") === "no") {
        nav.setAttribute("data-isMyMenuVisible", "yes");
    ...
    } else if (nav.getAttribute("data-isMyMenuVisible") === "yes") {
        nav.setAttribute("data-isMyMenuVisible", "no");
